...
public class RecipeGenerator extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        offerBarrelRecipe(withConditions(exporter,DefaultResourceConditions.allModsLoaded("regions_unexplored")),RegionsUnexplored.RU_CHERRY_BARREL, Registries.ITEM.get(new Identifier("regions_unexplored:cherry_planks")), Registries.ITEM.get(new Identifier("regions_unexplored:cherry_slab")));
        ...
        offerBarrelRecipe(withConditions(exporter,DefaultResourceConditions.allModsLoaded("regions_unexplored")),RegionsUnexplored.RU_SCULKWOOD_BARREL, Registries.ITEM.get(new Identifier("regions_unexplored:sculkwood_planks")), Registries.ITEM.get(new Identifier("regions_unexplored:sculkwood_slab")));
