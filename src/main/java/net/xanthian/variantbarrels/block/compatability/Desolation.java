...
public class Desolation {
    ...
    public static Map<Identifier, Block> DS_BARRELS = Maps.newHashMap();

    public static Block DS_CHARRED_BARREL;

    public static void registerBarrels() {
        DS_CHARRED_BARREL = registerBarrel("ds_charred_barrel");
    }

    public static Block register(String name, Block block) {
        Identifier identifier = new Identifier(Initialise.MOD_ID, name);
        Registry.register(Registries.BLOCK, identifier, block);
        DS_BARRELS.put(identifier, block);
